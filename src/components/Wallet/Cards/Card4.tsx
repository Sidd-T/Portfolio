    ...
    <div className=" bg-gradient-to-br from-purple-700 from-30% via-indigo-800 via-50% to-indigo-900 to-60% text-white rounded-2xl w-full h-full flex flex-col justify-start">
      ...
      // border-b border-black`}>
        <div className="mr-auto">
          <Info className="xs:text-md md:text-lg mr-2 self-center mb-1" />
          {"For Recruiters"}
        </div>
        <div>Info</div>
      </div>
      ...
      <div className="flex-grow rounded-b-2xl flex flex-row gap-8 items-start pt-4 bg-[url('https://www.transparenttextures.com/patterns/axiom-pattern.png')]"> 
        ...
        <div className="flex-grow flex flex-col gap-4 my-auto pb-[40%] sm:pt-[5%] md:pt-0 lg:pt-0 2xl:pt-[5%] pl-8"> 
          <div className={`${orbitron.className} ${cardOpen ? 'text-xl' : 'text-md'} font-bold border-b border-purple-900`}>
